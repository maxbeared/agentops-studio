...
export function LLMNode({ data, selected }: NodeProps) {
  const nodeData = data as WorkflowNodeData;
  return (
    <div className={`relative rounded-lg border border-blue-500 bg-blue-500/10 p-3 min-w-[160px] ${selected ? 'ring-2 ring-blue-400' : ''}`}>
...
export function RetrievalNode({ data, selected }: NodeProps) {
  const nodeData = data as WorkflowNodeData;
  return (
    <div className={`relative rounded-lg border border-purple-500 bg-purple-500/10 p-3 min-w-[160px] ${selected ? 'ring-2 ring-purple-400' : ''}`}>
...
export function ConditionNode({ data, selected }: NodeProps) {
  ...
  return (
    <div className={`relative rounded-lg border border-amber-500 bg-amber-500/10 p-3 min-w-[160px] ${selected ? 'ring-2 ring-amber-400' : ''}`}>
...
export function ReviewNode({ data, selected }: NodeProps) {
  const nodeData = data as WorkflowNodeData;
  return (
    <div className={`relative rounded-lg border border-pink-500 bg-pink-500/10 p-3 min-w-[160px] ${selected ? 'ring-2 ring-pink-400' : ''}`}>
